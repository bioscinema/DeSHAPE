...
dade_perm_multi(Shannon ~ Status,
               data        = plot_df,
...
dade_wald_contrast(Shannon ~ Status,
                   data = plot_df,
                   taus = c(0.25,0.75),
...
# adjust sequencing depth
dade_wald_contrast(Shannon ~ Status + Depth,
                   data = plot_df,
                   taus = c(0.25,0.75),
...
# adjust sequencing depth and other confounders
dade_wald_contrast(Shannon ~ Status + Depth + Gender + HbA1c,
                   data = plot_df,
                   taus = c(0.25,0.75),
...
### DADE 1: Median Diff Test
dade_perm_pair(Shannon ~ group_prefix,
               data        = plot_df,
               mode        = "center",     # or "dispersion", "skewness
               alternative = "greater",
               perm        = 10000,
